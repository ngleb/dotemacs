(when (string= (system-name) "ACER")
  (define-key ledger-mode-map (kbd "<f8>") 'my-ledger-report/body)
  (define-key ledger-mode-map (kbd "<f9>") 'ledger-mode-clean-buffer))

(define-key ledger-mode-map (kbd "M-<f8>") 'my-ledger-report/body)
