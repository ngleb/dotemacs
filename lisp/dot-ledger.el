...
(use-package ledger-mode
  ...
  (setq ledger-reports
        (quote
         (("bal" "%(binary) -f %(ledger-file) --strict bal")
          ("reg" "%(binary) -f %(ledger-file) --strict reg")
          ("payee" "%(binary) -f %(ledger-file) --strict reg @%(payee)")
          ("account" "%(binary) -f %(ledger-file) --strict reg %(account)")
          ("bal-assets" "%(binary) -f %(ledger-file) --strict bal assets and not Foreign and not Reim")
          ("bal-assets-full" "%(binary) -f %(ledger-file) --strict bal assets")
          ("exp-this-month" "%(binary) -f %(ledger-file) --strict -p \"this month\" bal expenses")
          ("exp-last-month" "%(binary) -f %(ledger-file) --strict -p \"last month\" bal expenses")
          ("exp-this-week" "%(binary) -f %(ledger-file) --strict -p \"this week\" --start-of-week=1 bal expenses")
          ("exp-last-week" "%(binary) -f %(ledger-file) --strict -p \"last week\" --start-of-week=1 bal expenses")
          ("bu-this-month" "%(binary) -f %(ledger-file) --strict -p \"this month\" bal --unbudgeted ^exp")
          ("bb-this-month" "%(binary) -f %(ledger-file) --strict -p \"this month\" bal --budget ^exp --invert")
          ("bu-last-month" "%(binary) -f %(ledger-file) --strict -p \"last month\" bal --unbudgeted ^exp")
          ("bb-last-month" "%(binary) -f %(ledger-file) --strict -p \"last month\" bal --budget ^exp --invert")
          ("reg-01" "%(binary) -f %(ledger-file) --strict -d \"d>=[last 45 days]\" reg assets:cash")
          ("reg-02" "%(binary) -f %(ledger-file) --strict -d \"d>=[last 45 days]\" reg assets:checking:a")
